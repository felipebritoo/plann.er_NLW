            ...
            <main className="flex gap-16 px-4">
                ...
                <div className="w-80 space-y-6">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">https://www.airbnb.com.br/rooms/104700011654654464565878767844878786</a>
                                </div>
                        ...
                        <button className='w-full justify-center bg-zinc-800 text-zinc-200 rounded-lg h-11 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>
                            <Plus className='size-5' />
                            Cadastrar novo link
                        </button>
                    </div>
